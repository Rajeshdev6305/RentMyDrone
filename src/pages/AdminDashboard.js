...
const AdminDashboard = ({ products, setProducts, currentAdmin }) => {
  ...
  return (
    <div className="flex flex-col lg:flex-row items-start justify-around mt-8 px-4">
      ...
      <div className="w-full lg:w-2/5">
        <div className="flex justify-between items-center mb-4">
          ...
          <button
            onClick={() => setViewMyProducts(!viewMyProducts)}
            className="bg-blue-600 text-white px-2 py-1 text-sm rounded flex items-center space-x-2"
          >
            {viewMyProducts ? <FaEyeSlash /> : <FaEye />}
            <span>
              {viewMyProducts ? "View All Products" : "View My Products"}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {groupedProducts[category]
                ...
                .map((product) => (
                  <div
                    key={product.id}
                    className="border p-4 shadow rounded-lg transition hover:shadow-lg hover:scale-105"
                  >
                    <img
                      src={product.image}
                      alt={product.name}
